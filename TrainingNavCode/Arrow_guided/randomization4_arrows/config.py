...
initialPos1 = Point3(52,48,0.8)
initialPos2 = Point3(40,4,0.8)
initialPos3 = Point3(44,8,0.8)
initialPos4 = Point3(52,48,0.8)
initialPos5 = Point3(36,48,0.8)
initialPos6 = Point3(20,32,0.8)
initialPos7 = Point3(4,16,0.8)
initialPos8 = Point3(48,52,0.8)
initialPos9 = Point3(8,52,0.8)
initialPos10 = Point3(12,32,0.8)
initialPos11 = Point3(4,52,0.8)
initialPos12 = Point3(52,40,0.8)
...
custLocs1 = [[52,44,0]]#location of custom goal for, e.g., training
custLocs2 = [[36,4,270]]#location of custom goal for, e.g., training
custLocs3 = [[44,12,180]]#location of custom goal for, e.g., training
custLocs4 = [[52,44,0]]#location of custom goal for, e.g., training
custLocs5 = [[36,44,0]]#location of custom goal for, e.g., training
custLocs6 = [[20,36,180]]#location of custom goal for, e.g., training
custLocs7 = [[4,20,180]]#location of custom goal for, e.g., training
custLocs8 = [[44,52,270]]#location of custom goal for, e.g., training
custLocs9 = [[12,52,90]]#location of custom goal for, e.g., training
custLocs10 = [[12,28,0]]#location of custom goal for, e.g., training
custLocs11 = [[4,48,0]]#location of custom goal for, e.g., training
custLocs12 = [[52,44,180]]#location of custom goal for, e.g., training
custZ = 0.2
...
environs = [3, 8, 6, 4, 2, 1, 10, 7, 12, 11, 9, 5]#  
