...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), May 04, 2016, at 15:04
...
expName = 'ratingScale'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\waglab\\Documents\\Thackery\\TBoy\\inscan_ratings\\ratingScale.psyexp',
...
rating = visual.RatingScale(win=win, name='rating', marker='triangle', size=1.2, low=1, high=4, labels=[''], scale='1=not much ... 4=great', singleClick=True)
stimulus_to_rate = visual.TextStim(win=win, ori=0, name='stimulus_to_rate',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath='C:\\Users\\waglab\\Documents\\Thackery\\TBoy\\inscan_ratings\\ratingScale.psyexp',
...
for thisTrial in trials:
    ...
    trialComponents.append(stimulus_to_rate)
    ...
    while continueRoutine:
        ...
        if t >= 0.4 and stimulus_to_rate.status == NOT_STARTED:
            # keep track of start time/frame for later
            stimulus_to_rate.tStart = t  # underestimates by a little under one frame
