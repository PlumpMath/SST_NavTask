...
initialPos1 = Point3(8,52,0.8)
initialPos2 = Point3(44,24,0.8)
initialPos3 = Point3(20,16,0.8)
initialPos4 = Point3(16,44,0.8)
initialPos5 = Point3(36,0,0.8)
initialPos6 = Point3(28,0,0.8)
initialPos7 = Point3(32,-4,0.8)
initialPos8 = Point3(40,4,0.8)
initialPos9 = Point3(4,8,0.8)
initialPos10 = Point3(40,52,0.8)
initialPos11 = Point3(40,52,0.8)
initialPos12 = Point3(24,4,0.8)
...
custLocs5 = [[36,4,180]]#location of custom goal for, e.g., training
custLocs6 = [[28,4,180]]#location of custom goal for, e.g., training
custLocs7 = [[28,-4,270]]#location of custom goal for, e.g., training
custLocs8 = [[44,4,90]]#location of custom goal for, e.g., training
custLocs9 = [[4,12,180]]#location of custom goal for, e.g., training
custLocs10 = [[36,52,270]]#location of custom goal for, e.g., training
custLocs11 = [[36,52,270]]#location of custom goal for, e.g., training
custLocs12 = [[28,4,90]]#location of custom goal for, e.g., training
custZ = 0.2
...
environs = [10, 2, 12]#, 4, 5, 6]
shockenvs = [1, 0, 0]#, 0, 1, 0]#which envs have shocks? 1 = yes
...
# Heads-up display.
fixationflag = 0 #if zero, code will display town shock status text instead of a fixation during ITI
